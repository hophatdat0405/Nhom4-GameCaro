...
public class CreateRoomPasswordFrm extends javax.swing.JFrame {
     ...
     */
     public CreateRoomPasswordFrm() {
        ...
        java.awt.Color grayText = new java.awt.Color(85, 85, 85); // xám đậm nhẹ
        ...
        if (passwordTextField != null) {
            passwordTextField.setBackground(java.awt.Color.WHITE);
            passwordTextField.setForeground(grayText);
            passwordTextField.setBorder(javax.swing.BorderFactory.createLineBorder(mintDark, 2));
            passwordTextField.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 14));
        }

        // --- Button ---
        if (loadingButton != null) {
            loadingButton.setBackground(mintDark);
            loadingButton.setForeground(java.awt.Color.WHITE);
            loadingButton.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
            loadingButton.setFocusPainted(false);
            loadingButton.setBorder(javax.swing.BorderFactory.createEmptyBorder(8, 16, 8, 16));
        }
    }
