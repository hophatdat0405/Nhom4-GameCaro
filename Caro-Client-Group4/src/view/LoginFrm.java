...
private void customizeColor() {
    ...
    // --- Màu tổng thể ---
    getContentPane().setBackground(new java.awt.Color(224, 247, 244)); // #E0F7F4 mint pastel

    // --- Khai báo màu ---
    java.awt.Color mintDark = new java.awt.Color(0, 150, 136); // #009688 mint đậm
    java.awt.Color mintMedium = new java.awt.Color(77, 182, 172); // #4DB6AC mint nhạt
    java.awt.Color greenPastel = new java.awt.Color(241, 248, 233); // #F1F8E9 xanh lá pastel
    java.awt.Color orangePastel = new java.awt.Color(255, 204, 188); // #FFCCBC cam pastel
    java.awt.Color grayText = new java.awt.Color(66, 66, 66); // xám đậm

    // --- jPanel1 màu trắng nhẹ tạo nổi khối ---
    ...
    passwordLabel.setForeground(mintMedium); // mint nhạt hơn tạo phân cấp

    // --- Màu input username ---
    usernameValue.setBackground(greenPastel); // xanh lá pastel
    usernameValue.setForeground(grayText);
    usernameValue.setBorder(javax.swing.BorderFactory.createLineBorder(mintDark, 1));
    usernameValue.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 12));

    // --- Màu input password ---
    passwordValue.setBackground(java.awt.Color.WHITE);
    passwordValue.setForeground(grayText);
    passwordValue.setBorder(javax.swing.BorderFactory.createLineBorder(mintMedium, 1));
    passwordValue.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 12));

    // --- Nút login ---
    loginButton.setBackground(mintDark);
    ...
    // --- Nút register (cam pastel điểm nhấn) ---
    registerButton.setBackground(orangePastel);
    registerButton.setForeground(grayText);
    registerButton.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12));
    registerButton.setFocusPainted(false);
    registerButton.setBorder(javax.swing.BorderFactory.createEmptyBorder(8, 15, 8, 15));

    // --- Tiêu đề frame nếu có ---
    if (frameLabel != null) {
        frameLabel.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 16));
