...
public class GameNoticeFrm extends javax.swing.JFrame {
   ...
   public GameNoticeFrm(String title, String message) {
    ...
    frameLabel.setForeground(new Color(52, 199, 178)); // #34C7B2 mint đậm

    // 🎨 Message label
    messageLabel.setText(message);
    messageLabel.setForeground(new Color(102, 102, 102)); // #666666

    // 🟠 Thêm border cam pastel xung quanh messageLabel
    messageLabel.setBorder(BorderFactory.createLineBorder(new Color(255, 211, 182), 2)); // #FFD3B6
