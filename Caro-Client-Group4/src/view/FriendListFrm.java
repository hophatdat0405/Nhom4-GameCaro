...
public FriendListFrm() {
        ...
        java.awt.Color purpleDeep = new java.awt.Color(156, 39, 176);
        java.awt.Color grayText = new java.awt.Color(66, 66, 66);
        java.awt.Color greenSuccess = new java.awt.Color(76, 175, 80);

        getContentPane().setBackground(java.awt.Color.WHITE);
        friendTable.setBackground(mintLight);
        friendTable.setForeground(grayText);
        friendTable.setSelectionBackground(mintDark);
        friendTable.setSelectionForeground(java.awt.Color.WHITE);
        friendTable.getTableHeader().setBackground(mintDark);
        friendTable.getTableHeader().setForeground(java.awt.Color.WHITE);
        friendTable.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 14));
        friendTable.getTableHeader().setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
        ...
        Thread thread = new Thread(() -> {
            while (Client.friendListFrm.isDisplayable() && !isClicked) {
                try {
                    ...
                    requestUpdate();
                    Thread.sleep(2000); // 2s là hợp lý, không gây quá tải server
