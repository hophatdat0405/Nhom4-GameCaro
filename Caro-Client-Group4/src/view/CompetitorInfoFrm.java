...
public class CompetitorInfoFrm extends javax.swing.JFrame {
   ...
   public CompetitorInfoFrm(User user) {
    try {
        ...
        java.awt.Color mintLight = new java.awt.Color(224, 242, 241); // #E0F2F1
        java.awt.Color grayDark = new java.awt.Color(85, 85, 85); // xám đậm
        java.awt.Color orangeDeep = new java.awt.Color(255, 87, 34); // cam đậm #FF5722

        // --- Nền tổng thể ---
        getContentPane().setBackground(mintLight);

        // --- Avatar ---
   jLabel6.setIcon(getScaledAvatarIcon("assets/avatar/" + user.getAvatar() + ".jpg", 85, 85));

        jLabel6.setBorder(javax.swing.BorderFactory.createLineBorder(mintDark, 3));

        // --- Nickname ---
        nicknameValue.setText(user.getNickname());
        nicknameValue.setForeground(mintDark);
        nicknameValue.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 16));

        // --- Thông số ---
        numberOfGameValue.setText("" + user.getNumberOfGame());
        numberOfGameValue.setForeground(grayDark);
        numberOfWinValue.setText("" + user.getNumberOfWin());
        numberOfWinValue.setForeground(mintDark);
        numberOfDrawValue.setText("" + user.getNumberOfDraw());
        numberOfDrawValue.setForeground(orangeDeep);
        rankValue.setText("" + user.getRank());
        rankValue.setForeground(mintDark);
        ...
        winRatioValue.setForeground(orangeDeep);
        markValue.setText("" + (user.getNumberOfWin() * 10 + user.getNumberOfGame()));
        markValue.setForeground(mintDark);

        // --- Label title hoặc frameLabel nếu có ---
        if (frameLabel != null) {
            frameLabel.setForeground(mintDark);
            frameLabel.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 18));
        }

        // --- Nút kết bạn / bạn bè ---
        Client.socketHandle.write("check-friend," + user.getID());

        jButton1.setBackground(mintDark);
        jButton1.setForeground(java.awt.Color.WHITE);
        jButton1.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 10, 5, 10));
        jButton1.setFocusPainted(false);

        // --- Label trạng thái bạn bè ---
        isFriendLabel.setForeground(grayDark);
        isFriendLabel.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 13));
...
public void checkFriend(boolean isFriend) {
    ...
    if (isFriend) {
     jButton1.setIcon(getScaledAvatarIcon("assets/icon/friendship.png", 95, 95));

        jButton1.setToolTipText("Bạn bè");
        isFriendLabel.setText("Bạn bè");
        isFriendLabel.setForeground(new java.awt.Color(76, 175, 80)); // xanh lá nhẹ #4CAF50
    } else {
        jButton1.setIcon(getScaledAvatarIcon("assets/icon/add-friend.png", 95, 95));
        jButton1.setToolTipText("Click để gửi yêu cầu kết bạn");
        isFriendLabel.setText("Kết bạn để chơi cùng nhau dễ dàng hơn");
        isFriendLabel.setForeground(new java.awt.Color(255, 87, 34)); // cam đậm
    }
}
