...
public GameClientFrm(User competitor, int room_ID, int isStart, String competitorIP) {
    ...
    // 🎨 Panel gamePanel (bàn cờ)
    gamePanel.setBackground(Color.WHITE);
    gamePanel.setLayout(new GridLayout(size, size));

    // 🔘 Setup play button với phối màu caro pastel
    button = new JButton[size][size];
    for (int i = 0; i < size; i++) {
        for (int j = 0; j < size; j++) {
            button[i][j] = new JButton("");
            // Phối caro mint và hồng pastel nhẹ
            if ((i + j) % 2 == 0) {
                button[i][j].setBackground(new Color(224, 247, 244)); // #E0F7F4 mint
            } else {
                button[i][j].setBackground(new Color(255, 236, 236)); // #FFECEC hồng pastel
            }
    ...
    // 🎨 Label player & competitor
    playerLabel.setFont(new Font("Arial", Font.BOLD, 15));
    playerLabel.setForeground(new Color(51, 51, 51)); // #333333
    competitorLabel.setFont(new Font("Arial", Font.BOLD, 15));
    competitorLabel.setForeground(new Color(51, 51, 51)); // #333333

    // 🎨 roomNameLabel
    roomNameLabel.setFont(new Font("Arial", Font.BOLD, 15));
    roomNameLabel.setAlignmentX(JLabel.CENTER);
    roomNameLabel.setForeground(new Color(102, 102, 102)); // #666666

    // 🎨 sendButton
    sendButton.setBackground(new Color(168, 230, 207)); // #A8E6CF mint đậm hơn
    sendButton.setForeground(new Color(51, 51, 51)); // #333333
    sendButton.setIcon(new ImageIcon("assets/image/send2.png"));

    // 👤 Player Info
    playerNicknameValue.setForeground(new Color(51, 51, 51));
    playerNumberOfGameValue.setForeground(new Color(102, 102, 102));
    playerNumberOfWinValue.setForeground(new Color(102, 102, 102));
 ...
 playerButtonImage.setIcon(getScaledAvatarIcon("assets/game/" + Client.user.getAvatar() + ".jpg", 60, 60));
    ...
    // 👤 Competitor Info
    competitorNicknameValue.setForeground(new Color(51, 51, 51));
    competotorNumberOfGameValue.setForeground(new Color(102, 102, 102));
    competitorNumberOfWinValue.setForeground(new Color(102, 102, 102));
    ...
    competotorButtonImage.setIcon(getScaledAvatarIcon("assets/game/" + competitor.getAvatar() + ".jpg", 60, 60));
    ...
    // 🔇 Ẩn các label không cần thiết ban đầu
    ...
    // 🖼️ Setup icon X/O
    normalItem = new String[]{"assets/image/x2.jpg", "assets/image/o2.jpg"};
    winItem = new String[]{"assets/image/xwin.jpg", "assets/image/owin.jpg"};
    iconItem = new String[]{"assets/image/x3.jpg", "assets/image/o3.jpg"};
    preItem = new String[]{"assets/image/x2_pre.jpg", "assets/image/o2_pre.jpg"};
